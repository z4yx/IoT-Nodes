...
#define y1 _fix_redeclared_y1
#define y0 _fix_redeclared_y0

static int AC1, AC2, AC3, VB1, VB2, MB, MC, MD;
static unsigned int AC4, AC5, AC6;
static double c5, c6, mc, md, x0, x1, x2, y0, y1, y2, p0, p1, p2;


static char readInt(char address, int *value);
...
static char readUInt(char address, unsigned int *value);
